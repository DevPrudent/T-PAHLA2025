  ...
  const categories = [
    {
      ...
      icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-8 h-8">
    ...
    <section id="awards" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          <Award size={48} className="mx-auto text-tpahla-gold mb-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="p-6">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-tpahla-purple/10 rounded-full text-tpahla-purple mb-4">
                  {category.icon}
                </div>
        ...
        <div className="mt-16 text-center">
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg border-t-4 border-tpahla-gold">
            <h3 className="text-2xl font-serif font-bold mb-4">Previous Winners</h3>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {[1, 2, 3].map((index) => (
                <div key={index} className="w-24 h-24 rounded-full overflow-hidden border-2 border-tpahla-purple">
                  <img 
                    src={`https://randomuser.me/api/portraits/${index % 2 === 0 ? 'women' : 'men'}/${index + 20}.jpg`} 
                    alt={`Past Winner ${index}`}
            ...
            <a href="#" className="mt-6 inline-block font-medium text-tpahla-purple hover:text-tpahla-darkpurple">
