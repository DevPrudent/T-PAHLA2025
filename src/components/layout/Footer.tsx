...
const Footer = () => {
  return (
    <footer className="bg-tpahla-darkgreen text-tpahla-text-secondary pt-16 pb-8 border-t-4 border-tpahla-gold">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="#" aria-label="Twitter" className="text-tpahla-text-secondary hover:text-tpahla-gold transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
              </a>
              <a href="#" aria-label="Instagram" className="text-tpahla-text-secondary hover:text-tpahla-gold transition-colors">
          ...
          <div>
            <h3 className="text-xl font-serif font-bold mb-4 text-tpahla-gold">Quick Links</h3>
            <ul className="space-y-2">
              <li><Link to="/about" className="text-sm hover:text-tpahla-gold transition-colors">About TPAHLA</Link></li>
              <li><Link to="/awards" className="text-sm hover:text-tpahla-gold transition-colors">Award Categories</Link></li>
              <li><Link to="/nominations" className="text-sm hover:text-tpahla-gold transition-colors">Nomination Process</Link></li>
              <li><Link to="/event" className="text-sm hover:text-tpahla-gold transition-colors">Event Details</Link></li>
              <li><Link to="/sponsors" className="text-sm hover:text-tpahla-gold transition-colors">Sponsorship</Link></li>
              <li><Link to="/register" className="text-sm hover:text-tpahla-gold transition-colors">Registration</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-tpahla-gold/20 pt-8 mt-8 text-center text-xs">
          <p>&copy; {new Date().getFullYear()} TPAHLA 2025. All rights reserved.</p>
          <p className="mt-2">Organized by the Institute for Humanitarian Studies and Social Development (IHSSD) and Hempawa Consult</p>
        </div>
      </div>
    </footer>
  );
