    ...
    <footer className="bg-tpahla-darkgreen text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 text-tpahla-gold mt-0.5" />
                <span className="text-gray-300">Abuja Continental Hotel, Nigeria</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-tpahla-gold" />
                <span className="text-gray-300">+234 123 456 7890</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-tpahla-gold" />
                <span className="text-gray-300">info@tpahla.org</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} The Pan-African Humanitarian Leadership Award. All rights reserved.</p>
