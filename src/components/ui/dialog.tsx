  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "print:shadow-none print:border-none print:bg-white print:fixed print:inset-0 print:w-full print:max-w-full print:h-full print:max-h-full print:translate-x-0 print:translate-y-0 print:overflow-y-auto",
        className
      )}
      {...props}
    >
