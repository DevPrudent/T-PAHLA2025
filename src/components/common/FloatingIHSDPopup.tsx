...
const FloatingIHSDPopup = () => {
  return (
    <a
      ...
      title="Visit IHSD Website"
    >
      <div className="flex items-center space-x-2">
        <Globe className="h-5 w-5 text-tpahla-gold group-hover:text-tpahla-gold transition-colors" />
        <p className="text-xs text-tpahla-text-primary group-hover:text-tpahla-gold transition-colors">
          Proudly organized by <span className="font-semibold">IHSD</span>
        </p>
      </div>
    </a>
  );
